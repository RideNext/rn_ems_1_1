 ...
 */
 ...
 public class DeviceManagerNetconfNotConnectHandler implements NetconfNodeStateListener {
     ...
     public void onCreated(NodeId nNodeId, NetconfNode netconfNode) {
         LOG.info("<<<<<  Started  onCreated ");
        SDNRLOG.info("IN onCreated() ");
